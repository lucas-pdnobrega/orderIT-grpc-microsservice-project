...
type CreateShippingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DeliverySpan  int32                  `protobuf:"varint,1,opt,name=delivery_span,json=deliverySpan,proto3" json:"delivery_span,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CreateShippingResponse) GetDeliverySpan() int32 {
	if x != nil {
		return x.DeliverySpan
	}
	return 0
}
...
const file_shipping_shipping_proto_rawDesc = "" +
	...
	"\x0eshipping_items\x18\x02 \x03(\v2\r.ShippingItemR\rshippingItems\"=\n" +
	"\x16CreateShippingResponse\x12#\n" +
	"\rdelivery_span\x18\x01 \x01(\x05R\fdeliverySpan2G\n" +
	"\bShipping\x12;\n" +
